...
Point::Point(double newXY){                                             // Consturctor with one value initialization
    m_x = newXY;
    m_y = newXY;
    std::cout << "Used as implicit conversion operators" << std::endl;
}

//// To prevent the usage of constructors are implicit conversion operators, declare the constructor as explicit:
//explict Point::Point(double newXY){
//    m_x = newXY;
//    m_y = newXY;
//    std::cout << "Used as implicit conversion operators" << std::endl;
//}

Point::Point(double newX, double newY){                                 // Constructor with two value initialization
    m_x = newX;
    m_y = newY;
