...
public:
    ...
    Point(double newXY);                                // Constructor used as implicit conversion operator
//    explicit Point(double newXY);                       // To prevent the constructors as implicit conversion operators
