...
namespace ZhehaoLi {
    ...
    namespace CAD{
        ...
        // Constructor
        Circle::Circle(): centerPoint(), radius(1.0)
        {                                                       // Default constructor
            std::cout << "Circle: Default constructor called." << std::endl;
        }

        Circle::Circle(const Point &cp, const double &r): centerPoint(cp), radius(r)
        {                                                       // Consturctor with two arguments
            std::cout << "Circle: Constructor called." << std::endl;
        }

        Circle::Circle(const Circle &c): centerPoint(c.centerPoint), radius(c.radius)
        {                                                       // Copy constructor
