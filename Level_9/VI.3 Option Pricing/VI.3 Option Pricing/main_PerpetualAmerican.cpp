//
//  main_PerpetualAmerican.cpp
//  VI.3 Option Pricing
//
//  Created by Zhehao Li on 2020/4/28.
//  Copyright © 2020 Zhehao Li. All rights reserved.
//
//  American Options -- Perpetual, a.k.a infinity time to expire
...
double PerpetualCall (double K, double S, double sig, double r, double b){      // Dividend q = r - b
    
    double sig2 = sig * sig;
    double fac = b / sig2 - 0.5;
    double y1 = 0.5 - b / sig2 + sqrt(pow(fac, 2) + 2.0 * r / sig2);
...
double PerpetualPut (double K, double S, double sig, double r, double b){
    ...
    double sig2 = sig * sig;
    double fac = b / sig2 - 0.5;
    double y2 = 0.5 - b/sig2 - sqrt(pow(fac, 2) + 2.0 * r / sig2);
