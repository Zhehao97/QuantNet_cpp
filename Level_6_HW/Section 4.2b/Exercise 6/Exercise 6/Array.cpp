...
namespace ZhehaoLi {
    ...
    namespace Containers{
        ...
        // Copy Constructor
        template <typename Type> Array<Type>::Array(const Array<Type> & A): m_size(A.Size()), m_data(new Type[A.m_size]){
            // A.m_size -> Access level is at the class level, not individual object
