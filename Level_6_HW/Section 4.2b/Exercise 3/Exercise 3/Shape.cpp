...
//
//  The implementation of base class Shape
...
//        std::cout << "Bye my Shape..." << std::endl;
    ...
    void Shape::Print() const{
        // Only part of that function is different for each derived class, which delegated to a polymorphic function (ToString())
