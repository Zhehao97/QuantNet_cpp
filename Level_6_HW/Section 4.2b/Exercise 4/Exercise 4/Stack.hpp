...
namespace ZhehaoLi {
    ...
    namespace Containers{
        ...
        public:
            ...
            Stack(int arrSize);                 // Constructor with values
            Stack(const Stack<Type> & S);       // Copy constructor
            
            /* Destructor */
            virtual ~Stack();
            
            /* Operators overloading */
            virtual Stack<Type> & operator = (const Stack<Type> & source);      // Assginment operator
